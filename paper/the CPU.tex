...
\hline
	...
	LOAD & \lt NUMBER \gt & `\backslash{}x0F XX` \\
	LOADADDR & \lt{}ADDRESS\gt & `\backslash{}x0E XX` \\
	ADD & \lt{}NUMBER\gt & `\backslash{}x7C XX` \\
	STORE & \lt{}ADDRESS\gt & `\backslash{}xE1 XX` 
\end{tabuler}
\end{center}
...
So in our case,`\backslash{}x0F` is the instruction that tells the CPU to `LOAD` a number in the accumulator.
...
\hline
	...
	if (condition) \{
		...
		<second code block>
	\end{lstlisting} & ```cmp 7\newline{}jne elseblock\newline{}\lt{}\textit{first code block}\gt{}\newline{}elseblock:\newline{}\lt{}\textit{second code block}\gt{}\newline{}done:\newline{}\lt{}\textit{more instructions...}\gt```
